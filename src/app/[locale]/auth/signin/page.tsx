      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-elevated rounded-2xl p-8 shadow-mango border border-border-light">
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary">Sign in to continue your studies</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleEmailSignIn}>
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="/auth/forgot-password" className="text-mango-secondary hover:text-mango-primary">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-text-secondary">
              ...
              <Link href="/auth/signup" className="text-mango-secondary hover:text-mango-primary">
                Sign up
              </Link>
            </p>
          </div>
