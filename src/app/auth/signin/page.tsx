      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-6">
            ...
            <h1 className="ml-3 text-2xl font-bold text-white">StudyAI</h1>
          </div>
        </div>
        ...
        <div className="bg-dark-secondary rounded-2xl p-8">
          ...
          <form className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="/auth/forgot-password" className="text-mango-500 hover:text-mango-400">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="my-6 text-center">
            <div className="flex items-center">
              ...
              <div className="px-4 text-gray-400 text-sm">Or continue with</div>
              <div className="flex-1 border-t border-gray-600"></div>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <Link href="/auth/signup" className="text-mango-500 hover:text-mango-400">
                Sign up
              </Link>
            </p>
          </div>
