        ...
        {isLoggedIn ? (
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gradient-mango rounded-2xl flex items-center justify-center shadow-mango">
              <span className="text-text-primary font-semibold text-sm">SC</span>
            </div>
            <div className="flex-1">
              <p className="text-text-primary text-sm font-semibold">Sophia Carter</p>
              <p className="text-text-muted text-xs mt-0.5">sophia.carter@email.com</p>
            </div>
            <button className="text-text-muted hover:text-text-primary transition-colors duration-200 p-2 rounded-xl hover:bg-surface-tertiary">
